...
use crate::core::models::{PersistentSeed, RefreshTokenData, RefreshTokenId};
use crate::core::types::{BearerToken, ClientId, Scope, TokenId};
...
impl TokenService {
    pub fn new(secret_path: &str, public_path: &str, issuer_prefix: String) -> Self {
        ...
        let public = {
            ...
            DecodingKey::from_ec_pem(&contents)
    ...
    pub fn validate_token_contains(
        &self,
        token: BearerToken,
        scope_entry: &str,
    ) -> Result<(), Error> {
